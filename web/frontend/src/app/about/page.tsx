        ...
        <div className="min-h-screen bg-white">
            ...
            <main className="max-w-3xl mx-auto px-6 py-12">
                ...
                <div className="prose prose-gray max-w-none">
                    <p className="text-lg text-gray-600 mb-8">
                        CathodeScreen is an enterprise-grade machine learning platform for predicting the thermodynamic
                    ...
                    <p className="text-gray-600 mb-4">
                        We use a <strong>CHGNet</strong> (Crystal Hamiltonian Graph Neural Network) ensemble to predict
                        the energy above the convex hull (E<sub>hull</sub>), the primary indicator of thermodynamic stability.
                    </p>

                    <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 my-6">
                        <h3 className="font-semibold text-gray-900 mb-2">v1-Li-Cathode Model</h3>
                        <ul className="text-sm text-gray-600 space-y-1">
                            <li>• CHGNet v0.3.0 with 412,525 parameters</li>
                            <li>• 5-member ensemble with different seeds</li>
                            <li>• Fine-tuned on Li-O-TM cathodes (SOAP-LOCO splits)</li>
                            <li>• Epistemic uncertainty via ensemble disagreement</li>
                        </ul>
                    </div>

                    <h2 className="text-xl font-semibold text-gray-900 mt-8 mb-4">Training Data</h2>
                    <p className="text-gray-600 mb-4">
                        The model was trained on <strong>11,377 Li-containing cathode materials</strong> from the Materials Project
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 my-6">
                        <p className="text-blue-800 text-sm font-medium">
                            On unseen Li-cathode chemistries, our system recovers <strong>55% of all ultra-stable
                                (E<sub>hull</sub> ≤ 10 meV) materials</strong> within the top-100 candidates — a <strong>6.6× enrichment</strong> over
                            random — while maintaining <strong>&lt;0.3% false-discard rate</strong>.
                        </p>
                    </div>

                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-6">
                        <div className="border border-gray-200 rounded-lg p-4 text-center">
                            <p className="text-3xl font-bold text-blue-600">6.66×</p>
                            <p className="text-sm text-gray-500">EF@1%</p>
                            <p className="text-xs text-gray-400 mt-1">Enrichment Factor</p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-4 text-center">
                            <p className="text-3xl font-bold text-green-600">0.032</p>
                            <p className="text-sm text-gray-500">MAE</p>
                            <p className="text-xs text-gray-400 mt-1">eV/atom</p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-4 text-center">
                            <p className="text-3xl font-bold text-indigo-600">55%</p>
                            <p className="text-sm text-gray-500">Recall@100</p>
                            <p className="text-xs text-gray-400 mt-1">at 10 meV</p>
                        </div>
                        <div className="border border-gray-200 rounded-lg p-4 text-center">
                            <p className="text-3xl font-bold text-emerald-600">&lt;0.3%</p>
                            <p className="text-sm text-gray-500">False Kill</p>
                    ...
                    <ol className="text-sm text-gray-600 space-y-2 list-decimal list-inside">
                        <li>Deng, B., et al. (2023). CHGNet: Pretrained universal neural network potential for charge-informed atomistic modelling. <em>Nature Machine Intelligence</em>.</li>
            ...
            <footer className="border-t border-gray-200 mt-16">
                <div className="max-w-4xl mx-auto px-6 py-6 flex justify-between text-sm text-gray-500 items-center">
                    <p>CathodeScreen · v1-Li-Cathode</p>
                    <SocialLinks />
                </div>
            </footer>
        </div>
